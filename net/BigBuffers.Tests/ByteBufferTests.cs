...
namespace BigBuffers.Test
{
    public class ByteBufferTests
    {
        ...
        public void ByteBuffer_GetByteReturnsCorrectData()
        {
            ...
            buffer[0] = 99;
            var uut = new ByteBuffer(buffer);
            Assert.AreEqual((byte)99, uut.GetByte(0));
        }
        ...
        public void ByteBuffer_GetShortReturnsCorrectData()
        {
            ...
            buffer[1] = 0;
            var uut = new ByteBuffer(buffer);
            Assert.AreEqual(1, uut.Get<short>(0));
        }
      ...
      [Test]
        ...
        public void ByteBuffer_Duplicate_MatchesBuffer()
        {
            ...
            Assert.AreEqual(0x0A0B, uut.Get<short>(2));

            // Advance by one more byte
            uut.Position = 1; uut = uut.Duplicate();
            Assert.AreEqual(0x0A, uut.GetByte(3));
        }
            ...
            where T : unmanaged
        {
            ...
            Assert.AreEqual( typeSize * data.Length, nSize);
        ...
        public void ByteBuffer_Get_Float()
        {
            ...
            uut.Put(900, value);
            double getValue = uut.Get<float>(900);
            Assert.AreEqual(value, getValue);
        }
    }
}
